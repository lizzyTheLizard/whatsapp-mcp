...
cpSync(resolve(mcpbuildPath, 'whatsapp-mcp.mcpb'), resolve(appDir, `whatsapp-mcp-${pkg.version}.mcpb`))
rmSync(mcpbuildPath, { recursive: true, force: true })
console.log(`Created whatsapp-mcp-${pkg.version}.mcpb at ${resolve(appDir, `whatsapp-mcp-${pkg.version}.mcpb`)}`)
